Vue.component("menadzer-artikli", {
    data() {
        return {
            artikli: [],
			slike: [],
	...
	<div v-show="imaRestoran">
        ...
        <!-- Modalni dijalog za izmenu artikala -->
        <div id = "dijalogZaIzmenuRestorana" v-bind:class="{bgModal: dijalogZaIzmenuSakriven, bgModalShow: !dijalogZaIzmenuSakriven}">
            <div class="modal-contents">
                ...
                <form method='post'>
                    ...
                    <input name="naziv" type="text" v-model="artikalZaIzmenu.naziv" placeholder="Naziv" required>
					
					<label for="tip">Tip:</label>
					<select name="tip" v-model="artikalZaIzmenu.tip" required>
                        <option>Jelo</option>
                        <option>Piće</option>
            		</select>

                    <label for="cena">Cena:</label>
                    <input name="cena" type="number" v-model="artikalZaIzmenu.cena" placeholder="Cena">
                    
                    <label for="kolicina">Količina:</label>
                    <input name="kolicina" type="text" v-model="artikalZaIzmenu.kolicina" placeholder="Količina">
                    
                    <label for="opis">Opis:</label>
                    <input  name="opis" type="text" v-model="artikalZaIzmenu.opis" placeholder="Opis">
    ...
    methods: {
        ...
        izmeniArtikal: function (artikal) {
            ...
            this.artikalZaIzmenu.ID = artikal.id;
            this.artikalZaIzmenu.tip = artikal.tip;
            this.artikalZaIzmenu.naziv = artikal.naziv;
            this.artikalZaIzmenu.cena = artikal.cena;
            this.artikalZaIzmenu.kolicina = artikal.kolicina;
            this.artikalZaIzmenu.opis= artikal.opis;
            this.artikalZaIzmenu.putanjaDoSlike = artikal.putanjaDoSlike;
        },
        obrisiArtikal: function (artikal) {
            axios
                .delete('rest/artikal/obrisiArtikal', {
                    data: {
                        artikal : artikal
                    }
                })
                .then(response => {
                    ...
                    toastr["success"]("Uspešno obrisan artikal!", "Uspešno brisanje!");
        ...
        potvrdiIzmene: function () {
            ...
            axios
                ...
                .then(response => {
                    ...
                    toastr["success"]("Uspešna izmena artikla!", "Uspešna izmena!");
                    return this.artikli;
                });
        },
        ...
        dobaviPutanjuSlike: function (artikal) {
            ...
            // Default image
            if (artikal.putanjaDoSlike == "withoutPath")
                return imageDefault;

            let slika;

            slika = this.dobaviBase64odIdja(parseInt(artikal.putanjaDoSlike, 10));
